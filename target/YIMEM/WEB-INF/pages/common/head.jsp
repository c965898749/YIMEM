...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="/main.html" style="">
                <span style="font-family: Cheatin;font-size: 28px;line-height: 25px"><span style="color: red">Y</span>ImEm</span>
                <%--<img alt="Charisma Logo" src="/statics/img/logo20.png"/>--%>
                <span style="line-height: 25px">后台管理</span>
            </a>
